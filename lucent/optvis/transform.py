...
def random_rotate(angles, units="degrees"):
    ...
    def inner(image_t):
        ...
        M = kornia.geometry.get_rotation_matrix2d(center, angle, scale).to(device)
        rotated_image = kornia.geometry.warp_affine(image_t.float(), M, dsize=(h, w))
